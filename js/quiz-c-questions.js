let questions = [
    ...
    {
    numb: 2,
    question: " Choose the Object oriented programming language from below.",
    ...
    {
    numb: 4,
    question: "In the declaration given below, what is “array”?",
    answer: " Identifier",
    options: [
      " Keyword",
      " Identifier",
    ...
    {
    numb: 5,
    question: "Which of the following statements is true about structures and unions?",
    answer: " The structure variable is of auto storage class by default",
    options: [
