let questions = [
    ...
    {
    numb: 2,
    question: " Assume that reference of head of following doubly linked list is passed to above function 1 <--> 2 <--> 3 <--> 4 <--> 5 <-->6. What should be the modified linked list after the function call?",
    answer: "6 <--> 5 <--> 4 <--> 3 <--> 2 <--> 1",
    options: [
      "2 <--> 1 <--> 4 <--> 3 <--> 6 <-->5",
      "	5 <--> 4 <--> 3 <--> 2 <--> 1 <-->6",
